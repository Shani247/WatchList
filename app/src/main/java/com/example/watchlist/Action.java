...
public class Action extends BaseActivity {
    ...
    private void initViews() {
        listA = findViewById(R.id.listAction);
        sp = getSharedPreferences("saveMovies", 0);
        String content = sp.getString("movies_action", "");
        ...
        listA.setText(spannable);
        listA.setMovementMethod(LinkMovementMethod.getInstance()); // חובה כדי שהלחיצות יעבדו
    ...
    private void showMovieDialog(String movieName) {
        ...
        btnPhoto.setOnClickListener(v -> {
            Intent intent = new Intent(Action.this, posters.class);
